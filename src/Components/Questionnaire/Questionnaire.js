      ...
      <form className="questions" onSubmit="">
        ...
        <div className="wakeUp">
          ...
          <div className="selectOption">
            ...
            <label htmlFor="wakeUpOptionMore">
              <input
                type="radio"
                value="more"
        ...
        <div className="asthmaSymptoms">
          ...
          <div className="selectOption">
            <label htmlFor="asthmaSymptomsOption0">
              <input
                type="radio"
                value="0"
            ...
            <label htmlFor="asthmaSymptomsOption1">
              <input
                type="radio"
                value="1"
            ...
            <label htmlFor="asthmaSymptomsOption2">
              <input
                type="radio"
                value="2"
            ...
            <label htmlFor="asthmaSymptomsOption3">
              <input
                type="radio"
                value="3"
            ...
            <label htmlFor="asthmaSymptomsOption4">
              <input
                type="radio"
                value="4"
            ...
            <label htmlFor="asthmaSymptomsOptionMore">
              <input
                type="radio"
                value="more"
        ...
        <div className="rescuePuffer">
          ...
          <div className="selectOption">
            <label htmlFor="rescuePufferOption0">
              <input
                type="radio"
                value="0"
            ...
            <label htmlFor="rescuePufferOption1">
              <input
                type="radio"
                value="1"
            ...
            <label htmlFor="rescuePufferOption2">
              <input
                type="radio"
                value="2"
            ...
            <label htmlFor="rescuePufferOption3">
              <input
                type="radio"
                value="3"
            ...
            <label htmlFor="rescuePufferOption4">
              <input
                type="radio"
                value="4"
            ...
            <label htmlFor="rescuePufferOptionMore">
              <input
                type="radio"
                value="more"
        ...
        <div className="missedEvent">
          ...
          <div className="selectOption">
            <label htmlFor="missedEventOptionNo">
              <input
                type="radio"
                value="no"
            ...
            <label htmlFor="missedEventOptionYes">
              <input
                type="radio"
                value="yes"
        ...
        <div className="stoppedExercising">
          <p>Has there been a time when you were exercising and had to stop because of asthma symptoms
            (in the last 3 months)?</p>
          <div className="selectOption">
            <label htmlFor="stoppedExercisingOptionNo">
              <input
                type="radio"
                value="no"
            ...
            <label htmlFor="stoppedExercisingOptionYes">
              <input
                type="radio"
                value="yes"
...
const mapDispatchToProps = dispatch => ( {
  onChangeQuestionnaireSelect:
    ( question, option ) => dispatch( actions.onChangeQuestionnaireSelect( question, option ) ),
} );
